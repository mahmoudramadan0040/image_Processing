...
export default class Save{
    ...
    public async Save_Thumb(save :process):Promise<null|string>{
        this.src = path.resolve(__dirname,'../assets/images/'+`${save.filename}.jpg`)
        this.dist = path.resolve(__dirname,'../assets/Thumb_Images/'+`${save.filename}_${save.width}__${save.height}_Thumb_image.jpg`)
